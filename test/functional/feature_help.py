...
"""Verify that starting californium with -h works as expected."""
...
class HelpTest(CaliforniumTestFramework):
    ...
    def run_test(self):
        self.log.info("Start californium with -h for help text")
        ...
        self.log.info("Start californium with -version for version information")
        ...
        self.log.info("Start californiumd with -fakearg to make sure it does not start")
