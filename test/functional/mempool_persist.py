...
By default, californiumd will dump mempool on shutdown and
...
class MempoolPersistTest(CaliforniumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent californiumd from writing mempool.dat to disk. Verify that `savemempool` fails")
