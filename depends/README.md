...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_californium` executable (see https://github.com/californium/californium/pull/13543),
...
options will be passed to californium's configure. In this case, `--disable-wallet`.
