...
libs = [
    'libcalifornium_cli',
    'libcalifornium_common',
    'libcalifornium_crypto',
    'libcalifornium_server',
    'libcalifornium_util',
    'libcalifornium_wallet_tool',
    'libcalifornium_wallet',
    'libcalifornium_zmq',
    'bench_californium',
    'libtest_util',
]
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/californium_config.h'), os.path.join(SOURCE_DIR, 'config/californium-config.h'))
