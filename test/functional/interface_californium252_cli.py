...
class TestCaliforniumCli(CaliforniumTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `californium-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and californium-cli getwalletinfo return expected wallet info")
            ...
            # Test californium-cli -generate with -rpcwallet in multiwallet mode.
