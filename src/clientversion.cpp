 ...
 * for both californiumd and californium-qt, to make it harder for attackers to
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/californium/bips/blob/master/bip-0014.mediawiki)
 */
