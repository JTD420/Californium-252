...
class BackwardsCompatibilityTest(CaliforniumTestFramework):
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes californiumd to exit, in addition to the RPC
        ...
        # Make sure this wallet opens without warnings. See https://github.com/californium/californium/pull/19054
