...
"""Test objects for interacting with a californiumd node over the p2p protocol.

The P2PInterface objects interact with the californiumd nodes under test using the
