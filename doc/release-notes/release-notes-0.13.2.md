Californium Core version 0.13.2 is now available from:
  ...
  <https://californium.org/bin/californium-core-0.13.2/>
...
- #8908 `4a974b2` Update californium-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow californium-tx to create v2 transactions (c252drak)
