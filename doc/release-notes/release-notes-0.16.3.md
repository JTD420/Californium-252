Californium Core version 0.16.3 is now available from:
  ...
  <https://californiumcore.org/bin/californium-core-0.16.3/>
...
### Miscellaneous
- #13655 `1cdbea7` californiumconsensus: invalid flags error should be set to `californiumconsensus_err` (afk11)
