...
// californium includes.
#include <..\src\script\californiumconsensus.h>
...
int main()
{
    std::cout << "californiumconsensus version: " << californiumconsensus_version() << std::endl;
    ...
    auto op0Result = californiumconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, californiumconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
