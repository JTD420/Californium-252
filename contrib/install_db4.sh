...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the californium repository."
  exit 1
fi
...
# See https://github.com/californium/californium/issues/16064
...
echo 'When compiling californiumd, run `./configure` in the following way:'
echo
