Californium Core version 0.9.4 is now available from:
  ...
  https://californium.org/bin/0.9.4/
...
Californium Core released binaries from https://californium.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~californium/+archive/ubuntu/californium
