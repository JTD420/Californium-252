...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.californium.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.californium.dashjr.org"); // Luke Dashjr
        vSeeds.emplace_back("seed.californiumstats.com"); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.californium.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.c252.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.californium.sprovoost.nl"); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de"); // Stephan Oeste
        vSeeds.emplace_back("seed.californium.wiz.biz"); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.californium.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tc252.petertodd.org");
        vSeeds.emplace_back("seed.testnet.californium.sprovoost.nl");
