...
- The oldest supported Python version is specified in [doc/dependencies.md](/doc/dependencies.md).
  ...
  The CI linter job also checks this, but [possibly not in all cases](https://github.com/californium/californium/pull/14884#discussion_r239585126).
...
with the californiumd(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a californiumd.  `P2PInterface`
...
Taken from the [python-californiumrpc repository](https://github.com/jgarzik/python-californiumrpc).
...
Test objects for interacting with a californiumd node over the p2p interface.

#### [script.py](test_framework/script.py)
Utilities for manipulating transaction scripts (originally from python-californiumlib)
