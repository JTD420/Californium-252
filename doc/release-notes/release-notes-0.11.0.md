Californium Core version 0.11.0 is now available from:
  ...
  <https://californium.org/bin/californium-core-0.11.0/>
...
For example, add the following to `californium.conf`:
...
related to the blockchain in the californium system: the raw blocks as received over 
...
For an example script see [californium-submittx](https://github.com/laanwj/californium-submittx).
...
- #5334 `cf87536` libcaliforniumconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new californium-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add californium logo to about screen
...
- #5809 `46bfbe7` Add californium-cli man page
...
- #5849 `41259ca` contrib/init/californiumd.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for californium-tx)
