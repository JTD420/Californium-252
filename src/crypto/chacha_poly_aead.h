...
/* A AEAD class for ChaCha20-Poly1305@californium.
 *
 ...
 *
 * The chacha20-poly1305@californium combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@californium cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@californium are relatively fast in
