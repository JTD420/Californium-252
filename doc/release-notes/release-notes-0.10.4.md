Californium Core version 0.10.4 is now available from:
  ...
  <https://californium.org/bin/californium-core-0.10.4/>
...
- #6953 `43c2789` Split californium-tx into its own package
- #6953 `dfe0d4d` Include californium-tx binary on Debian/Ubuntu
