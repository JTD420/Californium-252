...
const char * const CALIFORNIUM_CONF_FILENAME = "californium.conf";
 ...
 * https://github.com/californium/californium/pull/16097#issuecomment-514627823
 */
...
bool ArgsManager::ParseParameters(int argc, const char* const argv[], std::string& error)
{
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (key == "-") break; //californium-tx using stdin
        std::string val;
...
#else
    const char* pszModule = "californium";
#endif
    if (pex)
        return strprintf(
