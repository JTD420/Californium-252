Californium Core version 0.16.1 is now available from:
  ...
  <https://californiumcore.org/bin/californium-core-0.16.1/>
...
- #12843 `df38b13` Test starting californiumd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure californiumd processes are cleaned up when tests end (sdaftuar)
