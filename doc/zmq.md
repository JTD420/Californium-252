...
router", implementing the californium wire protocol and relay, making
...
during the *configure* step of building californiumd:
...
For instance:
    ...
    $ californiumd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubrawtx=ipc:///tmp/californiumd.tx.raw \
...
These options can also be provided in californium.conf.
...
From the perspective of californiumd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into californiumd directly. Furthermore, no information is
