...
{
    BOOST_CHECK(TestSplitHost("www.californiumcore.org", "www.californiumcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.californiumcore.org]", "www.californiumcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.californiumcore.org:80", "www.californiumcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.californiumcore.org]:80", "www.californiumcore.org", 80));
