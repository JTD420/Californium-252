    ...
    mapper(nullptr)
{
    ...
    ui->californiumAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->californiumAtStartup);
    ...
    ui->californiumAtStartup->setToolTip(ui->californiumAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->californiumAtStartup->setText(ui->californiumAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->californiumAtStartup, OptionsModel::StartAtStartup);
