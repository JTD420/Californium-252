...
[good first issue](https://github.com/californium/californium/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/californium/californium/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[Californium Core PR Review Club](https://californiumcore.reviews/) meeting.
...
`#californium-core-dev` channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/californium-core-dev/](http://www.erisian.com.au/californium-core-dev/)
and [http://gnusha.org/californium-core-dev/](http://gnusha.org/californium-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/californium-dev)
...
For GUI-related issues or pull requests, the https://github.com/californium-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/californium/californium node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to californium-qt
...
[Translation Process](https://github.com/californium/californium/blob/master/doc/translation_process.md)
...
https://github.com/californium/californium/pull/16189).

Also see the [backport.py script](
https://github.com/californium-core/californium-maintainer-tools#backport).
